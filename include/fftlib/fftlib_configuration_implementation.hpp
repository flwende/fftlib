...
namespace fftlib_internal
{
		  ...
		  flags(flags)
	{
		...
		if (in != NULL && out == NULL)
			...
			this->nthreads = FFTLIB_UNDEFINED_INT32;
		#else
		...
		hash = hasher::compute(this->n, this->howmany, this->inembed, this->istride, this->idist, this->onembed, this->ostride, this->odist, this->sign, this->flags, aligned, in_place, this->nthreads);		
	}
